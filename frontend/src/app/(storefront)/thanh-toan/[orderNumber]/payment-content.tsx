  ...
  if (error || !payment || !order) {
    return (
      <div className="container-lyla flex flex-col items-center gap-4 py-24 text-center">
        ...
        <Button variant="outline" className="rounded-full" render={<Link href="/tra-cuu-don-hang" />}>
          Tra cứu đơn hàng
        </Button>
      </div>
    );
      ...
      <div className="container-lyla flex max-w-lg flex-col items-center py-16 text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Button
            ...
            render={<Link href={`/don-hang/${order.orderNumber}?email=${encodeURIComponent(order.email)}`} />}
          >
            Xem đơn hàng
          </Button>
          <Button variant="outline" className="rounded-full" render={<Link href="/san-pham" />}>
            Tiếp tục mua sắm
          </Button>
        </div>
      </div>
    ...
    return (
      <div className="container-lyla flex max-w-lg flex-col items-center py-16 text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <Button variant="outline" className="rounded-full" render={<Link href="/lien-he" />}>
            Liên hệ hỗ trợ
          </Button>
        </div>
      </div>
