              ...
              <tr key={p._id} className="hover:bg-muted/30">
                <td className="px-4 py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <Link href={`/admin/products/${p._id}`} className="font-medium hover:underline">
                      {p.name}
                    </Link>
                  </div>
                </td>
                ...
                <td className="px-4 py-3">
                  <div className="flex justify-end gap-2">
                    <Button variant="ghost" size="icon-sm" render={<Link href={`/admin/products/${p._id}`} />} aria-label="Sửa">
